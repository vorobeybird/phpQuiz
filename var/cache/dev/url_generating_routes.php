...
return [
    ...
    'post.categories' => [['id'], ['_controller' => 'App\\Controller\\PostController::sortByCategory'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/post/categories']], [], []],
    'post.delete' => [['id'], ['_controller' => 'App\\Controller\\PostController::remove'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/post/delete']], [], []],
    'quiz.index' => [[], ['_controller' => 'App\\Controller\\QuizController::index'], [], [['text', '/quiz']], [], []],
    'makeQuestion' => [[], ['_controller' => 'App\\Controller\\QuizController::makeQuastion'], [], [['text', '/makeQuestion']], [], []],
    'makeAnswer.index' => [[], ['_controller' => 'App\\Controller\\QuizController::createAnswers'], [], [['text', '/makeAnswer']], [], []],
    'quiz_interface' => [['quiz_id'], ['_controller' => 'App\\Controller\\QuizController::quizProvider'], [], [['variable', '/', '[^/]++', 'quiz_id', true], ['text', '/quizInterface']], [], []],
