...
class Question extends \App\Entity\Question implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Question' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Question' . "\0" . 'answers', '' . "\0" . 'App\\Entity\\Question' . "\0" . 'title', '' . "\0" . 'App\\Entity\\Question' . "\0" . 'quiz'];
        }
     ...
     * {@inheritDoc}
     */
    public function setQuiz(?\App\Entity\Quiz $quiz): \App\Entity\Question
    {
